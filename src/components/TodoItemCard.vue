<template>
  <div class="w-full h-full p-4 rounded-xl todo-item-card">
    ...
    <div
      class="pb-5 todo-item-card_footer"
    >
    ...
    <div
      class="pb todo-item-card_footer"
    >
    <p data-cy="activity-item-date" class="mt-1 text-sm font-light">
    </p>
    </div>
    <div class="flex justify-end activity-card_footer">
      <div class="flex gap-1">
        <img src="@/assets/avatar-1.svg" alt="Avatar" class="avatar">
        <img src="@/assets/avatar-2.svg" alt="Avatar" class="avatar">
        <span class="icon-plus-avatar"></span>
      </div>
    </div>
  </div>
</template>
